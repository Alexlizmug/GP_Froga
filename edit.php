...
$password = "1MG2024";
$dbname = "gp_froga";
// 6.ariketa edit botoia klikatzean onutza ekartzen zaizu, bertan datu bati editatzeko botoia klikatzen diogunean aterako zaigu input type text batzuk eta jartzen dugunaren arabera botoiak klik ematen update egingo du
// Create connection
...
<form action="edit.php" method="get">
 ...
 <?php
 // Select bat egiten datu basean web orrialdean ateratzeko
